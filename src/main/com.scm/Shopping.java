...
public class Shopping extends Customer {
    ...
    // Constructor
    public Shopping(int userID, String userName, String email, String password, Date registerDate, Address address,
                    String shippingInfo) {
        super(userID, userName, email, password, registerDate, address, shippingInfo);
    ...
    public void addToCart(int productID) {
        Product product = Product.getProductFromDB(productID, getProductMap());
        if (product != null) {
